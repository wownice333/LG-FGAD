...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_local_epoch', type=int, default=10,
    ...
    if not args.convert_x:
        ...
        # datapath, normal_class, percentage, group = 'small'
    percentage = 0.8
    ...
    with open('./result_multi/' + args.data_group + '_result.txt', 'a') as f:
